...
# Some useful helpers
@ti.func
def project(pos: tm.ivec2, scalars: tm.vec2) -> tm.ivec2:
    return tm.ivec2((pos.x + 0.5) * scalars.x, (pos.y + 0.5) * scalars.y)

@ti.func
def in_bounds0(pos: tm.ivec2, upper_bound: tm.ivec2) -> bool:
    return pos.x >= 0 and pos.y >= 0 and pos.x < upper_bound.x and pos.y < upper_bound.y

@ti.func
def in_bounds(pos: tm.ivec2, lower_bound: tm.ivec2, upper_bound: tm.ivec2) -> bool:
